...
export default function ProductCard({ product }) {
  return (
    <Link
      ...
      className="group relative cursor-pointer bg-white border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col"
    >
      {/* Discount Badge */}
      {product.discount && (

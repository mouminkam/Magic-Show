...
const LoginSection = dynamic(
  () => import("./_components/LoginSection"),
  {
  ...
  return (
    <GuestOnly>
      <div className="bg-white min-h-screen">
        <PageSEO
          title={t(lang, "login") + " - Magic Show"}
          description="Login to your account"
          url="/login"
          keywords={[t(lang, "login")]}
        />
        <section className="login-section section-padding fix bg-white py-12 px-1 sm:px-5 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
